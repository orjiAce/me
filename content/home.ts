...
export const capabilities: { index: string; title: string; body: string }[] = [
  {
    index: "01",
    title: "Architecture & app foundations",
    body:
  ...
  },
  {
    ...
    body:
      "Live WebRTC streaming on Dolby Millicast with a custom native iOS Picture-in-Picture module at JIFU360, nurse-location tracking over Socket.IO at RightNowMD, chat on PubNub and plain WebSockets. The moving parts are the product, not a bolt-on.",
  },
  {
    index: "03",
    title: "Payments & fintech flows",
    body:
  ...
  {
    index: "04",
    title: "Ship, store, and iterate",
    body:
      "Seventeen products through App Store and Google Play review, with EAS builds and over-the-air updates as the release rail. Sentry in production so stability is measured, not assumed.",
  },
];
